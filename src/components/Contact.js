  ...
  return (
    <div className='flex flex-col'>
        <div className='flex flex-col items-center mt-16 mb-10'>
            <h1 className='font-bold text-4xl mb-3'>Contact Details</h1>
        ...
        <div className='flex items-center gap-28'>
            ...
            <form className=''>
                ...
                <label className='font-bold text-rose-400 text-3xl'>password</label>
                <input className='ml-8 bg-transparent text-center border-b-2 p-2 shadow-lg' type='password' placeholder='enter the password'></input><br/><br/>
                <button className='transition-all duration-1000 mt-8 font-bold hover:translate-x-10 text-green-700 px-2'>Send>>></button>
            </form>
        </div>
