...
function Bookings() {
  return (
    <div className='ml-80 mt-10 mb-4 bg-white rounded-xl shadow-2xl p-6 mr-40'>
      <form className=''>
        ...
        <div className='mt-2 mb-2 flex'>
          <div className='mr-2'>className='font-bold text-xl'
        ...
        <button className='transition-all duration-1000 mt-3 ml-2 font-bold hover:translate-x-10 text-green-700 px-4 py-2 bg-transparent border border-green-700 rounded-lg hover:bg-green-700 hover:text-white'><Link to='/payment'>Book now>>></Link></button>
      </form>
    </div>
  );
}
